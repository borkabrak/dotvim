...
vnoremap  "+y:let @*=@+:echom "Selection copied to system clipboard"
nnoremap  h
snoremap <silent>  c
...
snoremap  "_c
vnoremap  :!column -t
vnoremap  "+x:let @*=@+:echom "Selection moved to system clipboard"
...
vnoremap <silent> * y/0
vnoremap ,css :'<,'>!scss -s
nnoremap ,css mpggVG:'<,'>!scss -s`p
map ,rwp <Plug>RestoreWinPosn
map ,swp <Plug>SaveWinPosn
map ,fe :call foldsearch#foldsearch#FoldSearchEnd()
map ,fd :call foldsearch#foldsearch#FoldContextAdd(-1)
map ,fi :call foldsearch#foldsearch#FoldContextAdd(+1)
map ,fl :call foldsearch#foldsearch#FoldLast()
map ,fS :call foldsearch#foldsearch#FoldSpell()
map ,fw :call foldsearch#foldsearch#FoldCword()
map ,fs :call foldsearch#foldsearch#FoldSearch()
...
nmap ,B ,cdb 
nnoremap ,cdb :cd /cygdrive/c/Users/jcarter/biq
noremap ,Lgf :call OpenPartial()
vnoremap ,Ld o{{ dd() }}F(a
nmap ,LH ,Lh
nnoremap ,Lh o<pre>{{ }}</pre>?{a
nmap ,LL ,Ll
nnoremap ,Ll o\Log::info("");F(la
nmap ,LD ,Ld
nnoremap ,Ld o{{ dd() }}F(a
vnoremap ,rtW :call RemoveTrailingWhitespaceVisualConfirm()
vnoremap ,rtw :call RemoveTrailingWhitespaceVisual()
nnoremap ,rtW mx:call RemoveTrailingWhitespaceConfirm()`x
nnoremap ,rtw mx:call RemoveTrailingWhitespace()`x
nnoremap ,H mx"xyiw`x:help x
nnoremap ,uu mx0gu$`x
nnoremap ,UU mx0gU$`x
nnoremap ,ez :edit ~/.z
nnoremap ,eh :edit ~/
nnoremap ,ev :edit ~/.vim/
nnoremap ,todo OTODO: 
nnoremap ,gF :Ggrep '\<<cword>\>'gg``:copen
nnoremap ,gD :Ggrep 'function +\<<cword>\>'gg``:copen
nnoremap , :set nowrapscan:let @r.='@r'@r
nnoremap <silent> ,ml :call AppendModeline()
nnoremap ,Qp mt{gq}`t
nnoremap ,cL oconsole.log("");hhi
nnoremap ,h :set hlsearch!
nnoremap ,W :!x-www-browser <cfile>
nnoremap ,v :e $MYVIMRC
nnoremap ,i :set paste"+p:set nopaste
nnoremap ,U yypv$r━yy
nnoremap ,* yypv$r*yy
nnoremap ," yypv$r"yy
nnoremap ,# yypv$r#yy
nnoremap ,- yypv$r-yy
...
nnoremap ,x :!chmod +x %
nnoremap ,D :r!date +"\%F"
nnoremap ,t :r!date +"\%F \%r"
nnoremap ,@ oJon Carterborkabrak@gmail.com
nnoremap ,e :e
nnoremap ,S :edit $MYVIMRC:cd %:h
nnoremap ,s :source $MYVIMRC:echo "vimrc reloaded (we hope)."
nnoremap ,q :q
nnoremap ,d :bd
nnoremap ,w :w
nnoremap ,l :ls
...
nnoremap ,1 :b1
nnoremap ,  
nnoremap ,F :Unite -start-insert file_rec/async:!
nnoremap ,f :Unite file
nnoremap ,b :Unite buffer
nnoremap ,C :VCoolor
nnoremap , :CtrlPBuffer
nnoremap ,G :silent Ggrep <cword> | copen
nmap - <Plug>VinegarUp
vnoremap // /\%V
vnoremap : ;
nnoremap : ;
vnoremap ; :
nnoremap ; :
imap <silent> ÷ :VCoolIns raa
imap <silent> ö :VCoolIns ha
imap <silent> ò :VCoolIns ra
imap <silent> ã :VCoolora
nnoremap MM echom "Howdy"
map Q gq
...
nnoremap <BS> h
nnoremap <S-Tab> :bp
noremap <F7> :source ~/.vim/shutdown_session.vim
noremap <F6> :source ~/.vim/manual_session.vim
noremap <F5> :mksession! ~/.vim/manual_session.vim
nnoremap <F3> :CtrlPClearCache
...
nnoremap  <
nnoremap  >
nmap <silent> ÷ :silent VCoolIns ra
nmap <silent> ö :silent VCoolIns h
nmap <silent> ò :VCoolIns r
nmap <silent> ã :VCoolor
inoremap JJ 
inoremap jj 
cnoreabbr W Sudosave
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
set autoread
...
silent! normal! zE
let s:l = 202 - ((17 * winheight(0) + 17) / 35)
...
unlet! s:wipebuf
set winheight=1 winwidth=20 shortmess=atToOs
